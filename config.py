...
#data
args["PRETRAIN_VAL_SPLIT"] = 0.2   #validation set size fraction during pretraining
args["NUM_WORKERS"] = 8 #dataloader num_workers argument
args["PRETRAIN_NUM_WORDS"] = 2  #number of words limit in current curriculum learning iteration
...
args["BATCH_SIZE"] = 6 #minibatch size
args["STEP_SIZE"] = 6   #number of samples in one step (virtual epoch)
